...
let BrandfolderBrowser = class BrandfolderBrowser extends LitElement {
    ...
    _determineHeightConstraint() {
        ...
        const ancestor = this.closest(this?.layoutHostSelector);
        if (!ancestor) {
            return null;
        }
...
], BrandfolderBrowser.prototype, "layoutHostSelector", void 0);
__decorate([
    state()
...
__decorate([
    state()
], BrandfolderBrowser.prototype, "_height", void 0);
__decorate([
    state()
