 ...
 */
let BrandfolderAttachmentDetail = class BrandfolderAttachmentDetail extends BrandfolderAttachmentBase {
    /**
...
BrandfolderAttachmentDetail.styles = css `
    img {
      max-width: 100%;
      height: auto;
  ...
  `;
BrandfolderAttachmentDetail = __decorate([
    customElement('brandfolder-attachment-detail')
], BrandfolderAttachmentDetail);
export { BrandfolderAttachmentDetail };
//# sourceMappingURL=brandfolder-attachment-detail.js.map