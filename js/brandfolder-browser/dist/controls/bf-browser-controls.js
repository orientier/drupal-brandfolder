 ...
 */
let BfBrowserControls = class BfBrowserControls extends LitElement {
    /**
     * Constructor.
     */
    constructor() {
         ...
         */
        this._isOpen = false;
        this.addEventListener('bfControlInputChange', this._controlInputHandler);
        ...
        // field).
        this.addEventListener('bfControlsSubmit', this._controlsSubmissionHandler);
    }
    /**
...
], BfBrowserControls.prototype, "controlSchema", void 0);
__decorate([
    property({ type: String })
], BfBrowserControls.prototype, "browserFetchStatusMessage", void 0);
__decorate([
    state()
], BfBrowserControls.prototype, "_controlsInput", void 0);
__decorate([
    state()
], BfBrowserControls.prototype, "_isOpen", void 0);
__decorate([
    query('.brandfolder-browser-controls__creation-date')
], BfBrowserControls.prototype, "creationDateSelect", void 0);
__decorate([
    query('.brandfolder-browser-controls__modification-date')
], BfBrowserControls.prototype, "modificationDateSelect", void 0);
__decorate([
    query('.brandfolder-browser-controls__publication-date')
], BfBrowserControls.prototype, "publicationDateSelect", void 0);
__decorate([
    query('.brandfolder-browser-controls__sort-criterion')
], BfBrowserControls.prototype, "sortCriterionSelect", void 0);
__decorate([
    query('.brandfolder-browser-controls__sort-order')
], BfBrowserControls.prototype, "sortOrderSelect", void 0);
BfBrowserControls = __decorate([
    customElement('brandfolder-browser-controls')
], BfBrowserControls);
export { BfBrowserControls };
//# sourceMappingURL=bf-browser-controls.js.map