 ...
 */
let BfBrowserLabelsControl = class BfBrowserLabelsControl extends LitElement {
    constructor() {
        super(...arguments);
        /**
         * All eligible labels.
...
], BfBrowserLabelsControl.prototype, "allLabels", void 0);
__decorate([
    property({ type: Object, attribute: false })
], BfBrowserLabelsControl.prototype, "selectedLabels", void 0);
__decorate([
...
BfBrowserLabelsControl = __decorate([
    customElement('brandfolder-browser-labels-control')
], BfBrowserLabelsControl);
export { BfBrowserLabelsControl };
//# sourceMappingURL=bf-browser-labels-control.js.map